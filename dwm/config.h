...
char *fonts[]          = { "Hack Nerd Font Mono:pixelsize=21:antialias=true:autohint=true" };
...
static const char *bravecmd[] = { "/bin/brave", NULL };
static const char *pcmanfmcmd[] = { "/bin/pcmanfm", NULL };
static const char *lutriscmd[] = { "/bin/lutris", NULL };
static const char *bottlescmd[] = { "com.usebottles.bottles", NULL };
...
static Key keys[] = {
	...
	{ Mod4Mask,			XK_s,		spawn,		SHCMD("gamemoderun steam-runtime") },
	...
	{ Mod4Mask,			XK_f,		spawn,		{.v = bravecmd } },
	{ Mod4Mask,			XK_b,		spawn,		{.v = bottlescmd } },
	...
	{ Mod4Mask,			XK_m,		spawn,		SHCMD("exec ~/misc/appimages/mobalytics-1.102.238.AppImage") },
